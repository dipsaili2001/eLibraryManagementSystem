											...
											<div class="col">
												<asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" OnRowDataBound="GridView1_RowDataBound">
													<Columns>
													    ...
													    <asp:BoundField DataField="fine" FooterText="Fine - Rs. 10 / Day" HeaderText="Fine(Rupees)" NullDisplayText="N.A" ReadOnly="True" SortExpression="fine" />
													</Columns>
												</asp:GridView>
											</div>
										</div>
									<div class="row">
										<div class="col text-center font-weight-normal">
											<i>*Fine is calulated as Rs 10 / Per day from due date</i>
											</div>
										</div>
									</div>
								</div>
